                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-grow">
                      <div className="flex justify-between items-start">
                        ...
                        <p className="font-bold text-gray-800 bg-gray-100 px-2 py-1 rounded-md text-sm">${service.priceRange}</p>
                      </div>
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        <DialogTrigger asChild>
                           <Button size="sm" className="bg-gray-800 text-white hover:bg-gray-900 rounded-lg" onClick={() => setSelectedService(service)}>Book Service</Button>
                        </DialogTrigger>
                      </div>
                    </div>
                  </div>
