...
import { ArrowLeft, Bell, Calendar, Car, CheckCircle, ChevronRight, Clock, Compass, CreditCard, DollarSign, Download, Filter, Fuel, Headset, Heart, History, Home, LayoutDashboard, List, LogOut, MapPin, Moon, MoreHorizontal, Pencil, Search, Settings, Shield, ShieldCheck, SlidersHorizontal, Star, User, UserCog, Users, Wrench, X, type SVGProps } from "lucide-react";
...
export const Icons = {
  ...
  google: (props: SVGProps<SVGSVGElement>) => (
    <svg
      ...
      {...props}
    >
      <path d="M21.35,11.1H12.18V13.83H18.69C18.36,17.64 15.19,19.27 12.19,19.27C8.36,19.27 5,16.25 5,12C5,7.75 8.36,4.73 12.19,4.73C15.28,4.73 17.04,6.83 17.04,6.83L19.07,4.88C19.07,4.88 16.72,2.73 12.19,2.73C6.42,2.73 2,7.48 2,12C2,16.52 6.42,21.27 12.19,21.27C18.1,21.27 22,17.46 22,11.33C22,11.14 21.35,11.1 21.35,11.1Z" />
    </svg>
  ),
  bell: Bell,
  home: Home,
