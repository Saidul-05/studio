  ...
  (
    ...
    return (
      <aside
        ref={ref}
        className={cn(
            "group/sidebar hidden md:flex flex-col text-foreground border-r",
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[state=collapsed]:overflow-hidden p-2 px-3",
        className
      )}
      {...props}
    />
